                                ...
                                <div style="display: block;">
                                    ...
                                    ${file.title}&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <input type="text" style="display:none;" name="contentFiles[${file_index}].file"
                                               value="${file.file}"/>
                                        <br/>
                                        <input type="text" name="contentFiles[${file_index}].title" required="required"
                                               value="${file.title}" style="width: 300px;">
                                    </div>
                                    <div style="clear: both;"></div>
                                </div>
                            </#list>
                        </#if>
                        <input type="text" style="display:none;" id="contentFilesIDS" name="contentFilesIDS" value=""/>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var fileSize=${contentFiles?size};
        if(fileSize>0){
        ...
        $(document).on('click', 'div.contentFiles_upload>img', function () {
            var contentFilesId=$(this).next("input[flag='contentFilesId']");
            var contentFilesIDSObj=$("#contentFilesIDS");
            if(contentFilesId.length>0){
                contentFilesIDSObj.val(contentFilesIDSObj.val()+','+contentFilesId.val());
            }
