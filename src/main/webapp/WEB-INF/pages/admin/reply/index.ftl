...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="${path!}/admin/reply"><i class="fa fa-tag"></i> 回复</a></li>
            ...
            <div class="dataTables_wrapper form-inline dt-bootstrap">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="${path!}/topic/${reply.tid!}.html#${reply.id!}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="dataTables_paginate paging_simple_numbers">
                            ...
                            <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/admin/reply/index" urlParas="" />
                        </div>
                    </div>
                </div>
            </div>
