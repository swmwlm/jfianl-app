...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="${path!}/admin/mission"><i class="fa fa-tag"></i> 签到</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="dataTables_paginate paging_simple_numbers">
                            ...
                            <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/admin/mission/index" urlParas="" />
                        </div>
                    </div>
                </div>
            </div>
