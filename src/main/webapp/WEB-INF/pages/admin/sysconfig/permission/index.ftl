...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="${path!}/admin/permission">权限</a></li>
...
<script>
        ...
        $("#addPermissionBtn").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == '200') {
                        location.href = '${path!}/admin/permission?permissionId=' + data.detail.pid;
                    } else {
    ...
    function editPermission(id, pid) {
        ...
        url = '${path!}/admin/permission/edit';
    }

    function deletepermission(id, pid) {
        if (confirm("确定删除吗?")) {
            $.ajax({
                url: "${path!}/admin/permission/delete",
                async: false,
                cache: false,
                type: 'post',
                dataType: "json",
                ...
                success: function (data) {
                    if (data.code == '200') {
                        location.href = '${path!}/admin/permission?permissionId=' + data.detail;
                    } else {
                        alert(data.description);
                    }
                },
