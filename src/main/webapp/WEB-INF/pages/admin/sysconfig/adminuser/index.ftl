...
<section class="content">
    <div class="box">
        <div class="box-header">
            <a href="${path!}/admin/adminuser/add" class="btn btn-raised  btn-default pull-right">添加</a>
        </div>
        <div class="box-body">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr id="adminuser_${adminuser.id!}">
                            ...
                            <td>
                                <a href="${path!}/admin/adminuser/edit?id=${adminuser.id!}" class="btn btn-sm btn-primary">编辑</a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="dataTables_paginate paging_simple_numbers">
                            ...
                            <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/admin/adminuser" urlParas="" />
                        </div>
                    </div>
                </div>
            </div>
...
function deleteadminuser(id) {
    if (confirm("确定删除吗?")) {
        $.ajax({
            url: "${path!}/admin/adminuser/delete",
            async: false,
            cache: false,
            type: 'post',
            dataType: "json",
