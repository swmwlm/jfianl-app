...
<section class="content">
    <div class="box">
        <div class="box-header">
            <a href="${path!}/admin/role/add" class="btn btn-raised  btn-default pull-right">添加</a>
        </div>
        <div class="box-body">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr id="role_${role.id!}">
                            ...
                            <td>
                                <a href="${path!}/admin/role/edit?id=${role.id!}" class="btn btn-sm btn-primary">编辑</a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="dataTables_paginate paging_simple_numbers">
                            ...
                            <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/admin/role" urlParas="" />
                        </div>
                    </div>
                </div>
            </div>
