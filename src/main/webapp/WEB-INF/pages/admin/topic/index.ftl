...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="${path!}/admin/topic"><i class="fa fa-tag"></i> 话题</a></li>
                        ...
                        <tr id="topic_${topic.id!}">
                            ...
                            <td>
                                <@shiro.hasPermission name="topic:show_status">
                                    <#if topic.show_status == 1>
                                        <input type="button" value="显示" id="topic_show_btn_${topic.id!}"
                                               onclick="setShowStatus('${topic.id!}')" class="btn btn-raised btn-default "/>
                                    <#elseif topic.show_status == 0>
                                        <input type="button" value="不显示" id="topic_show_btn_${topic.id!}"
                                               onclick="setShowStatus('${topic.id!}')" class="btn btn-raised btn-warning "/>
                                    </#if>
                                </@shiro.hasPermission>
                            </td>
                            <td>${topic.in_time!}</td>
                            <td>
                                ...
                                <@shiro.hasPermission name="topic:delete">
                                    <a href="javascript:deleteTopic('${topic.id}')"><span
                                            class="glyphicon glyphicon-trash" title="删除"></span></a>
                                </@shiro.hasPermission>
                                <div class="modal fade" id="topic_detail_${topic.id!}" tabindex="-1" role="dialog"
