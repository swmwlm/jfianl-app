    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal" action="edit" method="post" onsubmit="return toValid();">
            <div class="box-body">
                ...
                <input type="hidden" name="rollImages.id" value="${rollimage.id!}">
                    ...
                    <div class="col-sm-5">
                        <select name="rollImages.dictId" id="dictId" class="form-control">
                            <#list rollimageDict! as dict>
                                <option value="${dict.id!}" <#if rollimage.dictId=dict.id>selected</#if> >${dict.value!}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="title" name="rollImages.title" maxlength="100"
                               placeholder="标题"  value="${rollimage.title!}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea class="form-control" rows="3" id="introduction" name="rollImages.introduction"
                                  placeholder="简介">${rollimage.introduction!}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5" id="pickfiles">
                        <img src="${imgPath!}${rollimage.imgSrc!}" id="imgUpload"
                             style="max-width: 500px;cursor: pointer;"/>
                        <input name="rollImages.imgSrc" id="imgSrc" type="hidden" value="${rollimage.imgSrc!}"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="linkUrl" name="rollImages.linkUrl"  value="${rollimage.linkUrl!}"
                    ...
                    <div class="col-sm-5">
                        <select name="rollImages.target" id="target" class="form-control">
                            <#list targetDict! as dict>
                                <option value="${dict.key!}" <#if rollimage.target="${dict.key!}">selected</#if> >${dict.value!}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="sort" name="rollImages.sort" maxlength="3" value="${rollimage.sort!}"
                               placeholder="排序">
                    </div>
                </div>
            </div>
