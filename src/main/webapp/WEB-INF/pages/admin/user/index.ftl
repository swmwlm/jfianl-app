...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="${path!}/admin/user"><i class="fa fa-tag"></i> 用户</a></li>
...
<section class="content">
    <div class="box">
        <div class="box-header">
            <form class="form-inline" method="get" action="${path!}/admin/user">
            ...
            <div class="dataTables_wrapper form-inline dt-bootstrap">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="${path!}/user/${user.id}">
                                <#if (user.avatar) ?? && (user.avatar != '')>
                                    <img src="${imgPath!}/${user.avatar!}" width="30">
                                <#else>
                                    <img src="${path!}/static/img/default_avatar.png" width="30">
                                </#if>
                                </a>
                            </td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="dataTables_paginate paging_simple_numbers">
                            ...
                            <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/admin/user/index" urlParas="" />
                        </div>
                    </div>
                </div>
            </div>
