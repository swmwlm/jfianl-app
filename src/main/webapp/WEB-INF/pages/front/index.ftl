...
<@html title="首页 - ${siteTitle!}" description="" page_tab="topic" sidebar_user_info="show" sidebar_checkin="show"
    ...
    <div class="panel panel-default">
                ...
                <li class="dropdown <#if tab != 'good' && tab != 'all' && tab != 'noreply'>active</#if>"
                    ...
                    <ul class="dropdown-menu">
                        <#list sections as section>
                            <li>
                                <a href="${path!}/?tab=${section.tab!}">${section.name!}</a>
                            </li>
                        </#list>
                    </ul>
                </li>
        ...
        <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/" urlParas="&q=${q!}&tab=${tab!}" />
    </div>
</@html>