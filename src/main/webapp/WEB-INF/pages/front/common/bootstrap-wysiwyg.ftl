...
<link rel="stylesheet" href="${path!}/static/bootstrap-wysiwyg/bower_components/google-code-prettify/src/prettify.css">
<link rel="stylesheet" href="${path!}/static/bootstrap-wysiwyg/bower_components/fontawesome/css/font-awesome.min.css">
<link rel="stylesheet" href="${path!}/static/bootstrap-wysiwyg/css/style.css">
...
<script src="${path!}/static/bootstrap-wysiwyg/bower_components/jquery.hotkeys/jquery.hotkeys.js"></script>
<script src="${path!}/static/bootstrap-wysiwyg/bower_components/google-code-prettify/src/prettify.js"></script>
<script src="${path!}/static/bootstrap-wysiwyg/src/bootstrap-wysiwyg.js"></script>
