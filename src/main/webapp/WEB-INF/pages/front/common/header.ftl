    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li <#if page_tab == 'topic'> class="active" </#if>><a href="${path!}/">社区</a></li>
                <li <#if page_tab == 'label'> class="active" </#if>><a href="${path!}/label">标签</a></li>
                <li <#if page_tab == 'api'> class="active" </#if>><a href="${path!}/api">API</a></li>
            </ul>
            <span class="hidden-xs hidden-sm">
                <form class="navbar-form navbar-left" id="search_form" role="search" method="get" action="${path!}/">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li <#if page_tab == 'donate'> class="active" </#if>><a href="${path!}/donate">捐赠</a></li>
                <li <#if page_tab == 'service'> class="active" </#if>><a href="${path!}/service">服务</a></li>
                <#if session.user??>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="${path!}/user/${session.user.id!}"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的</a></li>
                            <li><a href="${path!}/message"><span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;私信</a></li>
                            <li><a href="${path!}/user/setting"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;设置</a></li>
                            <li><a href="${path!}/logout"><span class="glyphicon glyphicon-off"></span>&nbsp;&nbsp;退出</a></li>
                        </ul>
                    </li>
                <#else>
                    <#--<li><a href="javascript:void(0);" data-toggle="modal" data-target="#loginModal">登录</a></li>-->
                    <li <#if page_tab == 'login'> class="active" </#if>><a href="${path!}/login.html">登录</a></li>
                    <li <#if page_tab == 'reg'> class="active" </#if>><a href="${path!}/reg.html">注册</a></li>
                </#if>
            </ul>
        </div>
    </div>
