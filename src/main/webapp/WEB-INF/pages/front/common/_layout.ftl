...
<body>
<#--页面头部信息-->
    <#include "/WEB-INF/pages/front/common/header.ftl"/>
    ...
    <div class="row">
        <div class="content-wrap">
            ...
            <div class="col-md-3 hidden-sm hidden-xs">
                <div id="jf_sidebar">
                    <#include "/WEB-INF/pages/front/common/sidebar.ftl"/>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function getCountnotread(_htmlTitle) {
            $.ajax({
                url: "${path!}/notification/countnotread",
                async: false,
                cache: false,
                type: 'post',
                dataType: "json",
...
<#--footer-->
    <#include "/WEB-INF/pages/front/common/footer.ftl"/>
    <@footer/>
</body>
</html>
</#macro>