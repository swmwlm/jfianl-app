            ...
            <div class="media">
                ...
                <div class="media-body">
                    <div class="media-heading">
                        <a href="${path!}/user/${session.user.id!}">${session.user.nickname!}</a>
                    </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="media">
            ...
            <div class="media-body">
                <div class="media-heading">
                    <a href="${path!}/user/${topic.author_id!}">${topic.nickname!}</a>
                </div>
                <p>积分: ${topic.score!}</p>
            </div>
...
<#if sidebar_checkin == "show">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <a href="${path!}/mission/daily" class="btn btn-raised btn-default ">领取今日的登录奖励</a>
        </div>
    </div>
    </#if>
</#if>
<#if sidebar_create == "show">
    <#if session.user??>
        <div class="panel panel-default">
            <div class="panel-body">
                <a href="${path!}/topic/create" class="btn btn-raised btn-default ">&nbsp;发布话题&nbsp;</a>
            </div>
        </div>
    </#if>
</#if>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <span class="glyphicon glyphicon-th-list"></span>
        <b>积分榜</b>&nbsp;&nbsp;<a href="${path!}/user/top100" class="small-gray">TOP100 &gt;&gt;</a>
    </div>
    <div class="panel-body">
            ...
            <div class="media" style="margin-top: 5px;">
                <div class="media-body">
                    <div class="row">
                        ...
                        <div class="col-sm-9"><a href="${path!}/user/${top.id}">${top.nickname!}</a></div>
                    </div>
                </div>
            </div>
