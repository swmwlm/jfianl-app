        ...
        <div class="media">
            ...
            <ul class="nav nav-pills">
                ...
                <#if collectPage.totalRow &gt; 0>
                    <li>
                        <a class="dark" href="${path!}/user/collects/${current_user.id!}">
...
<div class="panel panel-default">
    ...
    <div style="padding: 10px;">
        <a class="dark" href="${path!}/user/topics/${current_user.id!}">查看更多&gt;&gt;</a>
    </div>
</div>
<div class="panel panel-default">
    <div class="panel-heading">
    ...
    <div style="padding: 10px;">
        <a class="dark" href="${path!}/user/replies/${current_user.id!}">查看更多&gt;&gt;</a>
    </div>
</div>
<#--私信弹出框-->
