...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="media">
            ...
            <#else>
                <img src="${path!}/static/img/QQ24.png"/>
                腾讯QQ
            </#if>
            <div class="pull-right">
                ...
                <#else>
                    <a class="btn btn-raised btn-info btn-xs" href="${path!}/oauth/qqlogin?source=usersetting">立即绑定</a>
                </#if>
            </div>
        </div>
        ...
        <div class="media">
            ...
            <#else>
                <img src="${path!}/static/img/sinaweibo24.png"/>
                新浪微博
            </#if>
            <div class="pull-right">
                ...
                <#else>
                    <a class="btn btn-raised btn-info btn-xs" href="${path!}/oauth/weibologin?source=usersetting">立即绑定</a>
                </#if>
            </div>
        </div>
        <#--<div class="spacer"></div>-->
        <#--<div class="media">-->
            <#--<img src="${path!}/static/img/wechat24.png"/> 微信-->
            <#--<div class="pull-right">-->
    ...
    function cancelBind(pt) {
        if(confirm("确定要取消绑定吗？")) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == '200') {
                        location.href="${path!}/user/setting";
                    } else {
