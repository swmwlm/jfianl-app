...
<div class="panel panel-default">
    <div class="panel-heading">
        <ol class="breadcrumb">
            ...
            <li class="active">${current_user.nickname!} 参与的话题</li>
        </ol>
    </div>
    ...
    <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/user/replies/${current_user.id!}" urlParas="" />
</div>
</@html>