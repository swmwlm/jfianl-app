...
<div class="panel panel-default">
    <div class="panel-heading">
        <ol class="breadcrumb">
            ...
            <a href="${path!}/message" class="pull-right">返回私信列表</a>
        </ol>
    </div>
    <div class="panel-body">
        <div class="media">
            <div class="media-body">
                <form action="${path!}/message/save" method="post" id="newMessageForm">
            ...
            <div class="media-right">
                <a href="${path!}/user/${session.user.id!}">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <div class="alert <#if message.author_id == session.user.id>alert-info <#else> alert-success pull-right</#if>" role="alert" style="width: 80%;">
                        <p>
                            <#if message.author_id == session.user.id>
                                <a href="${path!}/user/${session.user.id!}">我</a>:
                            <#else>
                                <a href="${path!}/user/${session.user.id!}">${message.nickname!}</a>:
                            </#if>
                            ${message.content!}
                        </p>
                        <p class="small-fade">
                ...
                <#if message.author_id != session.user.id>
                    <div class="media-right">
                        <a href="${path!}/user/${message.author_id!}">
                            <img src="${message.avatar}" alt="" class="avatar">
                        </a>
                    </div>
                </#if>
