...
<div class="panel panel-default">
    <#if label??>
        <div class="panel-body" style="padding-bottom: 10px;">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <#if session.user??>
                        <p><a href="${path!}/topic/create/${label.name!}" class="btn btn-raised btn-sm btn-default">发布话题</a></p>
                    </#if>
                </div>
            </div>
        </div>
        ...
        <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${path!}/label/${label.name!}" urlParas="" />
    <#else>
        <div class="panel-body">
            标签未找到
        </div>
