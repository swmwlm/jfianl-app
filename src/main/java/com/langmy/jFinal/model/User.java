...
import com.langmy.jFinal.model.base.BaseUser;
...
//            role = Role.dao.findFirst("select * from sec_role where value='R_USER'");
            if (ValidateKit.isNullOrEmpty(role)) {
...
//            Follower following = Follower.dao.findFirst(" select * from  follower where user_id =" + this.get("id") + " AND link_id =" + this.get("id"));
            if (following != null) {
    ...
    public Role getRole() {
        ...
        //return Role.dao.findById(UserRole.dao.findFirst(" select * from sec_user_role where user_id=" + this.get("id")).get("role_id"));
    }
