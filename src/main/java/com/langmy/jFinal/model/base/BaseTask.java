...
public abstract class BaseTask<M extends BaseTask<M>> extends Model<M> implements IBean {
	...
	public void setBufferAt(java.util.Date bufferAt) {
		set("buffer_at", bufferAt);
	}

	public java.util.Date getBufferAt() {
		return get("buffer_at");
	}

	public void setActualBufferAt(java.util.Date actualBufferAt) {
		set("actual_buffer_at", actualBufferAt);
	}

	public java.util.Date getActualBufferAt() {
		return get("actual_buffer_at");
	}
