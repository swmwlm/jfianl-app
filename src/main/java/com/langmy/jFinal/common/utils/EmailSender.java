...
public class EmailSender {
    ...
    public EmailSender() {
        this.host = AppConstants.getValue("emailSmtp");
        this.username = AppConstants.getValue("emailUsername");
        this.password = AppConstants.getValue("emailPassword");
        this.mail_from = username;
        this.sender = AppConstants.getValue("emailSender");
    }
